...
import com.lavinmq.client.ConfirmListener;
...
public class LavinMqBenchmarkProducer implements BenchmarkProducer {

    private static final Logger log = LoggerFactory.getLogger(LavinMqBenchmarkProducer.class);
    ...
    public LavinMqBenchmarkProducer(Channel channel, String exchange, boolean messagePersistence) {
